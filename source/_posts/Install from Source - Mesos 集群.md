...
---
	...
	     sudo ./bin/mesos-agent.sh --master=zk://localhost:2181/mesos  --work_dir=/var/lib/mesos 
	...
	如果mesos没有注册到zookeeper 也就是 local 方式 或者 http://host:port ，命令如下：

	 $ sudo MESOS_NATIVE_JAVA_LIBRARY=/home/kennan/mesos-1.0.1/build/src/.libs/libmesos-1.0.1.so ./bin/start  --master  --zk zk://localhost:2181/marathon
